...
const TOOLS = {
  ...
  'list_memory_triggers':   { dept:'Memory & Hook', title:'列 memory triggers 狀態', desc:'掃描專案 memory dir 所有 .md 的 frontmatter triggers 欄位，列出哪些已設、哪些缺。配合 memory-auto-recall hook 用。', usage:'list_memory_triggers {project_id:"d--Project-PG-***", only_missing:false}', tools:[] },
