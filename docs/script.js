...
const SKILLS = {
  ...
  'sprint_plan':           { dept:'開發流程部',     title:'Tier-based 依賴層快速開發計畫', desc:'分析模組間的 DB 外鍵依賴關係，將工作拆解為 Tier 並行執行（同 Tier 並行、跨 Tier 循序），每模組附測試策略欄位，配合 /tdd + /sadd + /php_crud_test 完整工作流。', usage:'/sprint_plan {ProjectFolder} [規格來源]', tools:['list_files_batch','read_files_batch','get_db_schema_batch','create_file','create_file_batch'] },
