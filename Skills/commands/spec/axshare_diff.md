...
name: axshare_diff
description: |
  比對 AxShare 規格書與測試網站之間的功能差異。涵蓋：全站比對、單一模組深度分析、日期新增註記掃描、差異報告產出。
  當使用者說「比對規格」「看規格差異」「axshare」「規格書和網站不一樣」時使用。
---

# /axshare_diff — AxShare 規格書 vs 測試網站差異比對（支援全站 / 單一單元 / 日期註記掃描）
