...
| 後台網址 | adminControl 根目錄 URL | `http://localhost:8084/***_ERP/***_ERP_PHP/adminControl/` |
| 登入帳號 | 後台帳號 | `admin` |
...
> 例如 `D:\Project\***_ERP\***_ERP_PHP\` → `http://localhost:8084/***_ERP/***_ERP_PHP/adminControl/`
...
1. **VSCode 開啟 Listen for Xdebug**：
   - 開啟 `D:\Project\***_ERP\***_ERP_PHP\.vscode\launch.json`
