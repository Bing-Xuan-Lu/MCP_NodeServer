...
| 工具 | 用途 |
|------|------|
| `Glob` | 列出 memory/ 下所有 *.md 檔案 |
| `Read` | 讀取 MEMORY.md 與各記憶檔內容 |
| `Grep` | 偵測 MEMORY.md 索引引用、孤兒檔案掃描 |
| `Edit` | 修正 MEMORY.md 索引、移除死連結 |
| `Write` | 產出合併後的記憶檔、寫入 audit 報告 |
| `Bash` | rm 過時記憶檔、清理 reports/ 舊報告 |
