...
| 參數 | 說明 | 範例 |
|------|------|------|
| `{{PROJECT_DIR}}` | 專案資料夾名稱 | `***_ERP` |
| `{{PHP_DIR}}` | PHP 專案資料夾名稱 | `***_ERP_PHP` |
...
❌ 錯誤：list_files("***_ERP_PHP/adminControl/empmeetingnote")
```
...
- 錯誤示範：`list_files("***_ERP_PHP/adminControl/...")`
- 正確示範：`list_files("***_ERP/***_ERP_PHP/adminControl/...")`
